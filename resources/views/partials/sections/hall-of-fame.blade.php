<div class="section-wrapper d-flex flex-row justify-content-center align-items-center">
    ...
    <img class="arrow-left img-fluid animated fadeInLeft d-none" src="{{ asset('/assets/png/arrow-left.svg') }}" data-direction="previous" data-page="hall-of-fame" alt="previous">
    @foreach($artists as $index => $artist)
        <a class="artist mobile-artist no-padding-margin animated fadeIn mobile" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}" style="position: absolute;">
            ...
            <p class="artist-name w-100 text-center d-flex align-items-center justify-content-center no-padding-margin">{{ $artist->name }}</p>
        </a>
        @if($index % 5 === 0)
