<div class="section-wrapper d-flex flex-row justify-content-center align-items-center">
    ...
    @foreach($artists as $index => $artist)
        @if($index % 5 === 0)
        <a class="first-artist artist col-3 no-padding-margin" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}">
        ...
        @elseif($index % 5 === 1)
        <a class="second-artist artist col-3 no-padding-margin" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}">
            <div class="col-12 d-flex justify-content-center no-padding-margin" style="height: 100%;">
                <img src="{{ url('/storage') }}/{{ $artist->thumbnail_path }}" class="thumbnail img-fluid" alt="{{ $artist->name }}">
            </div>
            <img src="{{ asset('/assets/png/hall-of-fame-mobile.png')}}" class="polaroid-frame">
        ...
        @elseif($index % 5 === 2)
        <a class="third-artist artist col-3 no-padding-margin" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}">
            <div class="col-12 d-flex justify-content-center no-padding-margin" style="height: 100%;">
                <img src="{{ url('/storage') }}/{{ $artist->thumbnail_path }}" class="thumbnail img-fluid" alt="{{ $artist->name }}">
            </div>
            <img src="{{ asset('/assets/png/hall-of-fame-mobile.png')}}" class="polaroid-frame">
        ...
        @elseif($index % 5 === 3)
        <a class="fourth-artist artist col-3 no-padding-margin" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}">
            <div class="col-12 d-flex justify-content-center no-padding-margin" style="height: 100%;">
                <img src="{{ url('/storage') }}/{{ $artist->thumbnail_path }}" class="thumbnail img-fluid" alt="{{ $artist->name }}">
            </div>
            <img src="{{ asset('/assets/png/hall-of-fame-mobile.png')}}" class="polaroid-frame">
        ...
        @elseif($index % 5 === 4)
        <a class="fifth-artist artist col-3 no-padding-margin" target="_blank" href="{{ $artist->social_media_url }}" data-artist="{{ $artist->name }}">
            <div class="col-12 d-flex justify-content-center no-padding-margin" style="height: 100%;">
                <img src="{{ url('/storage') }}/{{ $artist->thumbnail_path }}" class="thumbnail img-fluid" alt="{{ $artist->name }}">
            </div>
            <img src="{{ asset('/assets/png/hall-of-fame-mobile.png')}}" class="polaroid-frame">
