<div class="section-wrapper d-flex flex-column justify-content-center align-items-center" style="z-index: 2;">
    ...
    <a class="facebook-button d-none col-6 col-sm-2 col-md-6 col-lg-2 no-padding-margin d-flex align-items-center justify-content-center" target="_blank" href="{{ $contacts[0]->facebook_url }}" style="position: absolute; bottom: 0;">
